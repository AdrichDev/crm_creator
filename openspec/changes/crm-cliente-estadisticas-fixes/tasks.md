...
- [x] V.2 CERRADO (2026-06-25): código verificado theme-safe (sin hardcodes del scope; `bg-white/[0.03]` translúcido válido en ambos temas). Vistazo humano = verificación opcional. Change CERRADO.
