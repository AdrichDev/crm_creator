...
- [ ] 9.12 Mapa comercial: mostrar como pines tanto la cartera de clientes (Customer, ya está) COMO los Contactos (tabla contacto, hoy sin geo). Requiere geo en Contacto (migración lat/long/geoEstado), geocodificarlos, y renderizarlos en el mapa distinguibles de los clientes.
