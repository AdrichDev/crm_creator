...
- [ ] 9.4 Vista de Presupuestos y Facturas equivalente a agents-agency (misma logica de funcionamiento y visual, tanto editar estado, nuevo presupuesto modelo de presupuesto (sin imagen)) Tambien ha de poder editarse en caso de no estar en estado rechazada,  quitar columna docs y añadir columna fecha. Tambien se ha de poder ordenar por numero de factura y presupuesto, cliente fecha y estado. Todo esto tiene que pegar a la base de datos modificar schema y actualizar
