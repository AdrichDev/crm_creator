...
export const VERTICALS: VerticalDef[] = [
  {
    ...
    defaultModules: ['clientes', 'citas', 'servicios', ...BASE_PERSONAS, 'productos', 'ventas', 'marketing'],
    terminology: { citas: 'Citas', empleados: 'Estilistas', servicios: 'Servicios', clientes: 'Clientes' },
    branding: { primary: '#1b431c', secondary: '#8cc63f' },
  },
  {
  ...
  },
  {
    ...
    defaultModules: ['clientes', 'citas', 'productos', 'ventas', 'empleados', 'fichaje', 'vacaciones', 'marketing'],
  ...
  },
  {
    ...
    defaultModules: ['clientes', 'citas', 'servicios', 'empleados', 'fichaje', 'vacaciones', 'productos', 'ventas', 'marketing'],
  ...
  },
  {
    ...
    defaultModules: ['clientes', 'citas', 'servicios', 'empleados', 'productos', 'ventas'],
  ...
  },
  {
    ...
    defaultModules: ['clientes', 'citas', 'servicios', 'empleados', 'fichaje', 'vacaciones', 'productos', 'ventas'],
