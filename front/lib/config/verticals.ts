...
export const VERTICALS: VerticalDef[] = [
  {
    ...
    defaultModules: ['clientes', 'citas', 'servicios', ...BASE_PERSONAS, 'productos', 'ventas', 'facturas', 'marketing'],
  ...
  },
  {
    ...
    defaultModules: ['clientes', 'citas', 'productos', 'ventas', 'facturas', 'empleados', 'fichaje', 'vacaciones', 'marketing'],
  ...
  },
  {
    ...
    defaultModules: ['clientes', 'citas', 'servicios', 'empleados', 'fichaje', 'vacaciones', 'productos', 'ventas', 'facturas', 'marketing'],
  ...
  },
  {
    ...
    defaultModules: ['clientes', 'citas', 'servicios', ...BASE_PERSONAS, 'fichaje', 'ventas', 'facturas', 'marketing'],
    terminology: { citas: 'Citas', empleados: 'Abogados', servicios: 'Áreas de práctica', clientes: 'Clientes', ventas: 'Facturación' },
