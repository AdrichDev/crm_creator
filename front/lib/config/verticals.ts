...
export const VERTICALS: VerticalDef[] = [
  {
    ...
    defaultModules: ['clientes', 'citas', 'servicios', ...BASE_PERSONAS, 'productos', 'ventas', 'pedidos', 'facturas', 'marketing', 'estadisticas'],
  ...
  },
  {
    ...
    defaultModules: ['clientes', 'citas', 'productos', 'ventas', 'pedidos', 'facturas', 'empleados', 'fichaje', 'vacaciones', 'marketing', 'estadisticas'],
  ...
  },
  {
    ...
    defaultModules: ['clientes', 'citas', 'servicios', 'empleados', 'fichaje', 'vacaciones', 'productos', 'ventas', 'pedidos', 'facturas', 'marketing', 'estadisticas'],
  ...
  },
  {
    ...
    defaultModules: ['clientes', 'citas', 'servicios', 'empleados', 'productos', 'ventas', 'pedidos', 'facturas'],
  ...
  },
  {
    ...
    defaultModules: ['clientes', 'citas', 'servicios', 'empleados', 'fichaje', 'vacaciones', 'productos', 'ventas', 'pedidos', 'facturas'],
  ...
  },
  {
    ...
    defaultModules: ['clientes', 'citas', 'servicios', ...BASE_PERSONAS, 'fichaje', 'ventas', 'pedidos', 'facturas', 'marketing', 'estadisticas'],
  ...
  },
  {
    ...
    defaultModules: ['clientes', 'citas', 'servicios', 'empleados', 'fichaje', 'vacaciones', 'productos', 'ventas', 'pedidos', 'facturas', 'marketing', 'estadisticas', 'categorias'],
  ...
  },
  {
    ...
    terminology: { citas: 'Agenda', empleados: 'Comerciales', servicios: 'Servicios y tarifas', clientes: 'Cartera de clientes', ventas: 'TPV', comercial: 'Mapa comercial', estadisticas: 'Informes' },
