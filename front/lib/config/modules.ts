...
export const MODULES: ModuleDef[] = [
  { id: 'dashboard', termKey: 'dashboard', defaultLabel: 'Dashboard', description: 'Resumen y KPIs del negocio.', category: 'core', icon: 'LayoutDashboard', href: '/panel', mandatory: true },
  { id: 'clientes', termKey: 'clientes', defaultLabel: 'Clientes', description: 'CRM: fichas, historial y segmentos de clientes.', category: 'operativa', icon: 'Users', href: '/clientes' },
  { id: 'citas', termKey: 'citas', defaultLabel: 'Agenda', description: 'Agenda y reservas con estados.', category: 'core', icon: 'CalendarClock', href: '/citas', recommends: ['servicios'] },
  { id: 'servicios', termKey: 'servicios', defaultLabel: 'Servicios', description: 'Catálogo de servicios: duración y precio.', category: 'retail', icon: 'Scissors', href: '/servicios' },
  ...
  { id: 'pedidos', termKey: 'pedidos', defaultLabel: 'Presupuestos', description: 'Presupuestos comerciales documentales, con vista previa imprimible.', category: 'retail', icon: 'ClipboardList', href: '/pedidos', recommends: ['clientes'] },
  { id: 'facturas', termKey: 'facturas', defaultLabel: 'Facturas', description: 'Facturación y documentos del cliente.', category: 'retail', icon: 'FileText', href: '/facturas', recommends: ['clientes'] },
...
export const CATEGORY_LABEL: Record<ModuleCategory, string> = {
  core: 'Área de Trabajo',
  operativa: 'Clientes / Lead',
  personas: 'Personas',
  retail: 'Facturación',
  marketing: 'Data',
};
