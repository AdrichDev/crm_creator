...
export const MODULES: ModuleDef[] = [
  ...
  { id: 'empleados', termKey: 'empleados', defaultLabel: 'Empleados', description: 'Plantilla, roles y especialidades.', category: 'personas', icon: 'IdCard', href: '/empleados' },
  { id: 'fichaje', termKey: 'fichaje', defaultLabel: 'Fichaje', description: 'Control de jornada e imputación de horas.', category: 'personas', icon: 'Clock', href: '/fichaje', recommends: ['empleados'] },
